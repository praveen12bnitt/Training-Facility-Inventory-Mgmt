...
<form:hidden path="transactionType" />
	...
	<br/> 	
	<a id="goback" href="javascript:history.go(-1)" class="form-button ui-state-default ui-corner-all" style="padding: .2em 1em; " >Go back</a>
	<br/>
	<br/>
	...
	<%@ include file="/WEB-INF/ui/transaction-result.jsp" %>
		...
		<table id="transDetails" class="ui-widget item-table trans-details">				
			<tbody class="ui-widget-content trans-details" >
				<tr>
					<td>Transaction Description</td><td>Receive Inventory into warehouse </td>
				</tr>
